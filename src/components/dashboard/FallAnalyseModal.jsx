...
export default function FallAnalyseModal({ cases, onClose }) {
  ...
  const analyse = async () => {
    ...
    const prompt = `Du bist ein erfahrener Rechtsanwalt und Jurist. Analysiere den folgenden Fall und erstelle:
      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-xl">
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-bold text-gray-900 text-sm">KI-Fallanalyse</h2>
              <p className="text-xs text-gray-400">Automatisierte Zusammenfassung & Einschätzung</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          {selectedCase && !loading && !result && (
            <button onClick={analyse}
              ...
              <Scale className="w-4 h-4" /> KI-Analyse starten
            </button>
          )}
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-10 gap-3">
              ...
              <p className="text-sm text-gray-500">Analyse wird generiert…</p>
              <p className="text-xs text-gray-400">Dies kann 15–30 Sekunden dauern</p>
            </div>
          )}
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setResult(null)}
                  className="text-xs text-gray-400 hover:text-gray-600 underline">Neue Analyse</button>
              </div>
              ...
              <p className="text-xs text-gray-400 text-center">
                ⚠ Diese Analyse ersetzt keine rechtliche Beratung und dient ausschließlich als Orientierungshilfe. Verwendet Claude Sonnet (mehr Integrationskredite).
              </p>
            </div>
          )}
        </div>
