...
const TABS = [
  ...
  {id:4,label:"Fristen"},{id:5,label:"Strategie"},{id:6,label:"KI-Berater"},{id:7,label:"Analyse"},{id:8,label:"Risiken"},{id:9,label:"Simulation"},{id:10,label:"Dokumente"},{id:11,label:"Gesamtbewertung"},{id:12,label:"Verhandlung"},{id:13,label:"Schriftsatz"},{id:14,label:"Cockpit"},{id:15,label:"Prozess-Zeitachse"},{id:16,label:"Historie"},
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <p className="text-xs text-gray-400 mb-4">SCHRITT {activeTab} VON 16</p>
        ...
        {activeTab===16 && <TabHistory caseId={caseId} />}
