...
const TABS = [
  ...
  {id:7,label:"Strategie"},{id:8,label:"KI-Berater"},{id:9,label:"Analyse"},{id:10,label:"Dokumente"},{id:11,label:"Notizen"},
];
...
export default function CaseDetail() {
  ...
  const completedTabs = [!!caseData.fallname,counts.args>0,counts.evidence>0,counts.args>1,counts.persons>0,counts.deadlines>0,!!caseData.prognose,!!caseData.ki_berater_result,!!caseData.streitwert,false,!!caseData.notes];
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <p className="text-xs text-gray-400 mb-4">SCHRITT {activeTab} VON 11</p>
        ...
        {activeTab===11 && <TabNotizen caseId={caseId} caseData={caseData} onUpdate={d=>{setCaseData(d);}} />}
        ...
        <div className="flex items-center justify-between mt-8 pt-4 border-t border-gray-100">
          ...
          <button onClick={() => setActiveTab(t=>Math.min(11,t+1))} disabled={activeTab===10} className="flex items-center gap-1 text-sm text-gray-800 font-medium hover:text-gray-600 disabled:opacity-30">
